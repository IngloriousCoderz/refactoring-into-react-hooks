...
<LiveCode title="State" code={require('!raw-loader!./live-coding/state')} />
...
<LiveCode
  title="useState"
  code={require('!raw-loader!./live-coding/use-state')}
/>
...
<LiveCode title="Refs" code={require('!raw-loader!./live-coding/refs')} />
...
<LiveCode title="useRef" code={require('!raw-loader!./live-coding/use-ref')} />
...
<LiveCode
  title="Lifecycle"
  code={require('!raw-loader!./live-coding/lifecycle')}
/>
...
<LiveCode
  title="useEffect"
  code={require('!raw-loader!./live-coding/use-effect')}
/>
...
<LiveCode title="HoCs" code={require('!raw-loader!./live-coding/hocs')} />
...
<LiveCode title="memo" code={require('!raw-loader!./live-coding/memo')} />
...
<LiveCode
  title="Render props"
  code={require('!raw-loader!./live-coding/render-props')}
/>
...
<LiveCode
  title="useCallback"
  code={require('!raw-loader!./live-coding/use-callback')}
/>
...
<LiveCode title="Context" code={require('!raw-loader!./live-coding/context')} />
...
<LiveCode
  title="useContext"
  code={require('!raw-loader!./live-coding/use-context')}
/>
...
<LiveCode
  title="Reducers"
  code={require('!raw-loader!./live-coding/reducers')}
/>
...
<LiveCode
  title="useReducer"
  code={require('!raw-loader!./live-coding/use-reducer')}
/>
...
<LiveCode title="Redux" code={require('!raw-loader!./live-coding/redux')} />
...
<LiveCode
  ...
  code={require('!raw-loader!./live-coding/use-reducer-and-context')}
/>
